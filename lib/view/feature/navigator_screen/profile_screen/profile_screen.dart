...
class ProfilePage
    extends BaseView<ProfilePage, ProfileScreenAction, ProfileScreenState> {
  ...
  @override
  Widget render(BuildContext context, ProfileScreenAction action,
    ...
    return SafeAreaWithPadding(
      ...
      children: [
        ...
        ProfileMenuElement(
            '로그아웃', Icons.logout, ProfileScreenMenuType.logout, onTapHandler),
      ],
    ));
  }
}
