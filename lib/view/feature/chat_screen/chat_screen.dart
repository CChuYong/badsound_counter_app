            ...
            Expanded(
              child: RefreshIndicator(
                ...
                child: CustomScrollView(reverse: false, slivers: [
                  ...
                  SliverToBoxAdapter(
                      child: MiniInfoMessage('혼자 있는 방에선 나쁜말이 적립되지 않아요',
                          size: 11.sp)),
                ]),
              ),
            ),
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                      hintText:
                          "${action.state.speaker?.nickname ?? ''}님의 나쁜말 입력하기...",
                      contentPadding:
                  ...
                  child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: action.state.speaker != null
                                ? DecorationImage(
                                    image: CachedNetworkImageProvider(
                                        action.state.speaker!.profileImgUrl))
                                : null),
                      )),
                )
              ],
