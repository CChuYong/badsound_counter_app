...
class ChatSpeakerSelectorScreenAction extends BaseAction<
    ChatSpeakerSelectorScreen,
    ChatSpeakerSelectorScreenAction,
    ChatSpeakerSelectorScreenState> {
  final ChatScreenAction chatScreenAction;

  ChatSpeakerSelectorScreenAction(
      List<MeResponse> members, this.chatScreenAction)
      : super(ChatSpeakerSelectorScreenState(members));
