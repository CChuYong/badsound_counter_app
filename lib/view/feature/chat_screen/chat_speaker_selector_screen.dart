...
class ChatSpeakerSelectorScreen extends BaseView<ChatSpeakerSelectorScreen,
    ChatSpeakerSelectorScreenAction, ChatSpeakerSelectorScreenState> {
  ...
  @override
  ChatSpeakerSelectorScreenAction initAction() =>
      ChatSpeakerSelectorScreenAction(members, chatScreenAction);

  @override
  Widget render(BuildContext context, ChatSpeakerSelectorScreenAction action,
      ChatSpeakerSelectorScreenState state) {
    return Container(
